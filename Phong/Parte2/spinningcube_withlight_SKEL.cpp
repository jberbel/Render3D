...
// Vertex Buffer Object (for vertex coordinates)
  ...
  normal_tw_location = glGetUniformLocation(shader_program, "normal_to_world");
  ...
  view_position_location = glGetUniformLocation(shader_program, "view_pos");
...
void render(double currentTime) {
  ...
  glm::mat4 cube1, view_matrix, proj_matrix, cube2;
  glm::mat3 normal_to_world_matrix;
  ...
  glUniformMatrix4fv(model_location, 1, GL_FALSE, glm::value_ptr(cube1));
  ...
  normal_to_world_matrix = glm::inverseTranspose(glm::mat3(cube1));
  glUniformMatrix3fv(normal_tw_location, 1, GL_FALSE, glm::value_ptr(normal_to_world_matrix));
  ...
  cube2 = glm::mat4(1.f);
  cube2 = glm::translate(cube2, glm::vec3(1.0f, 0.5f, 0.0f)); // Se determina la posición del cubo2 respecto al cubo1
  cube2 = glm::scale(cube2, glm::vec3(0.75f));;

  cube2 = glm::rotate(cube2,
                          glm::radians((float)currentTime * 45.0f),
                          glm::vec3(0.0f, 1.0f, 0.0f));
  cube2 = glm::rotate(cube2,
                          glm::radians((float)currentTime * 81.0f),
  ...
  glUniformMatrix4fv(model_location, 1, GL_FALSE, glm::value_ptr(cube2));
